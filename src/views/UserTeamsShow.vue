<template>
  ...
  <tr>
    <td>{{ user_team.rb1.player_name  }}</td>
  ...
  <tr>
    <td>{{ user_team.rb2.player_name  }}</td>
  ...
  <tr>
    <td>{{ user_team.wr1.player_name  }}</td>
  ...
  <tr>
    <td>{{ user_team.wr2.player_name  }}</td>
  ...
  <tr>
    <td>{{ user_team.te.player_name  }}</td>
  ...
  <tr>
    <td>{{ user_team.flex.player_name  }}</td>
